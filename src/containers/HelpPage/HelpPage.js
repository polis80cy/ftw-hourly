        ...
        <LayoutWrapperMain className={css.staticPageWrapper}>
          ...
          <div className={css.contentWrapper}>
            <div className={css.contentMain}>
              ...
              <button class="collapsible">What is Jiffystudio?</button>
              <div class="content">
              ...
              <button class="collapsible">How can I request to book a photo studio?</button>
              <div class="content">
              ...
              <button class="collapsible">Do I need to create an account?</button>
              <div class="content">
              ...
              <button class="collapsible">How can I create an account?</button>
              <div class="content">
              ...
              <button class="collapsible">How can I delete my account?</button>
              <div class="content">
              ...
              <button class="collapsible">What are your charges?</button>
              <div class="content">
              ...
              <button class="collapsible">Can I list my studio for free?</button>
              <div class="content">
                Yes, listings are free. We only charge a commission when a booking has been accepted.
              </div>

              <button class="collapsible">Why do you need my banking info?</button>
              <div class="content">
              ...
              <button class="collapsible">why do you ask for my banking info upfront (during listing addition process)?</button>
              <div class="content">
                To discourage fraudulent listings, and power automatic payouts to you at the time of booking.
              </div>

              <button class="collapsible">What happens to my banking info once I share it? I don't trust you with it.</button>
              <div class="content">
              ...
              <button class="collapsible">Why Stripe? Why not Paypal, Square or, even better, offline payments?</button>
              <div class="content">
              ...
              <button class="collapsible">How do I add payout information?</button>
              <div class="content">
              ...
              <button class="collapsible">I accepted a booking request. When will the money enter my bank account?</button>
              <div class="content">
              ...
              <button class="collapsible">How can I enforce a cancellation policy?</button>
              <div class="content">
