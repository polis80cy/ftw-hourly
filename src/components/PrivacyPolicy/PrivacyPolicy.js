...
const PrivacyPolicy = props => {
  ...
  return (
    <div className={classes}>
      ...
      <p>
        <p>
          Your privacy is important to us. It is Jiffystudio's policy to respect your privacy regarding any
          information we may collect from you across Jiffystudio.
        </p>
        <p>
        ...
        <p>This policy is effective as of 11 January 2020.</p>
      </p>
    </div>
  );
};
